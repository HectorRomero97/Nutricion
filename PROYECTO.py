...
class animales(KnowledgeEngine):
    ...
    @Rule(Fact(animal = 'animal' << L("animal")))
    def a_1 (self, animal):
        print(".: SISTEMA EXPERTO DEL REINO ANIMAL :.")
        print(" ")
        self.declare(Fact(animal = "animal", extinto = input("¿Es un animal extinto? (s/n): ")))
#EXINTOS
    @Rule(Fact(animal = L("animal"), extinto = L("s")))
    def a_11(self):
        print("Es un animal extinto")
        self.declare(Fact(animal = "animal", extinto = "s", colmillos = input("¿Tenia colmillos? (s/n): ")))

    @Rule(Fact(animal = L("animal"), extinto = L("s"), colmillos = L("s")))
    def a_111(self):
        print("Es un animal extinto y tenia colmillos")
        self.declare(Fact(animal = "animal", extinto = "s", colmillos = "s", felino = input("¿Era un felino? (s/n): ")))

    @Rule(Fact(animal = L("animal"), extinto = L("s"), colmillos = L("s"), felino = L("s")))
    def a_1111(self):
        print("El animal que busca es un DIENTES DE SABLE")
        self.declare(Fact(animal = "dientes de sable", extinto = "s", colmillos = "s", felino = "s"))

    @Rule(Fact(animal = L("animal"), extinto = L("s"), colmillos = L("s"), felino = L("n")))
    def a_1112(self):
        print("El animal que busca es un MAMUT")
        self.declare(Fact(animal = "mamut", extinto = "s", colmillos = "s", felino = "n"))

    @Rule(Fact(animal = L("animal"), extinto = L("s"), colmillos = L("n")))
    def a_112(self):
        print("Es un animal extinto y no tenia colmillos")
        self.declare(Fact(animal = "animal", extinto = "s", colmillos = "n", ave = input("¿Era un ave? (s/n): ")))

    @Rule(Fact(animal = L("animal"), extinto = L("s"), colmillos = L("n"), ave = L("s")))
    def a_1121(self):
        print("El animal que busca es un PTERODACTYLUS")
        self.declare(Fact(animal = "animal", extinto = "s", colmillos = "n", ave = "s"))

    @Rule(Fact(animal = L("animal"), extinto = L("s"), colmillos = L("n"), ave = L("n")))
    def a_1122(self):
        print("Es un animal extinto, no tenia colmillos y no es un ave")
        self.declare(Fact(animal = "animal", extinto = "s", colmillos = "n", ave = "n", gigante = input("¿Era gigante? (s/n): ")))

    @Rule(Fact(animal = L("animal"), extinto = L("s"), colmillos = L("n"), ave = L("n"), gigante = L("n")))
    def a_11222(self):
        print("El animal que busca es un VELOCIRAPTOR")
        self.declare(Fact(animal = "velociraptor", extinto = "s", colmillos = "n", ave = "n", gigante = "n"))

    @Rule(Fact(animal = L("animal"), extinto = L("s"), colmillos = L("n"), ave = L("n"), gigante = "s"))
    def a_11221(self):
        print("Es un animal extinto, sin colmillos y es gigante")
        self.declare(Fact(animal = "animal", extinto = "s", colmillos = "n", ave = "n", gigante = "s", cuernos = input("¿Tenia cuernos? (s/n): ")))

    @Rule(Fact(animal = L("animal"), extinto = L("s"), colmillos = L("n"), ave = L("n"), gigante = L("s"), cuernos = L("s")))
    def a_112211(self):
        print("El animal que busca es un TRICERATOP")
        self.declare(Fact(animal = "triceratop", extinto = "s", colmillos = "n", ave = "n", gigante = "s", cuernos = "s"))
